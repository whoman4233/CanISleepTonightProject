	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				v.positionOS = mul( GetWorldToObjectMatrix(), float4( v.positionOS.xyz, 0 ) );
				 ...
				 ) : SV_Target
			{
				...
				float4 transform9_g103 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float4 transform9_g102 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				...
				float screenDepth17_g101 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth17_g101 = abs( ( screenDepth17_g101 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
				float depthToLinear18_g101 = Linear01Depth(distanceDepth17_g101,_ZBufferParams);
				float luminance26 = Luminance(RayColor22.rgb);
				float RayPreAlpha43 = ( ( luminance26 * RayColor22.a * IN.ase_color.r ) * _Intensity );
				float FinalAlpha57 = saturate( ( ( _UseCameraDepthFade == 1.0 ? saturate( (0.0 + (distance( transform9_g103 , float4( _WorldSpaceCameraPos , 0.0 ) ) - _CameraDepthFadeStart) * (1.0 - 0.0) / (_CameraDepthFadeEnd - _CameraDepthFadeStart)) ) : 1.0 ) * ( _UseCameraDistanceFade == 1.0 ? saturate( (0.0 + (distance( transform9_g102 , float4( _WorldSpaceCameraPos , 0.0 ) ) - _CameraDistanceFadeEnd) * (1.0 - 0.0) / (_CameraDistanceFadeStart - _CameraDistanceFadeEnd)) ) : 1.0 ) * saturate( ( _UseZScaleFade == 1.0 ? ase_parentObjectScale.z : 1.0 ) ) * ( _UseSceneDepthFade == 1.0 ? ( isOrtho31 == 0.0 ? saturate( (0.0 + (distanceDepth4_g100 - _DepthFadeStartDistance) * (1.0 - 0.0) / (_DepthFadeEndDistance - _DepthFadeStartDistance)) ) : saturate( ( 1.0 - depthToLinear18_g101 ) ) ) : 1.0 ) * RayPreAlpha43 ) );
...
Node;AmplifyShaderEditor.ColorNode;15;-2640,-48;Inherit;False;Property;_VariationColor;Variation Color;21;2;[HDR];[PerRendererData];Create;True;0;0;0;False;0;False;1,1,1,0.454902;1.763311,1.032861,0.6404479,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;12;-2640,-224;Inherit;False;Property;_MainColor;Main Color;0;2;[HDR];[PerRendererData];Create;True;0;0;0;False;0;False;1,1,1,0.454902;2.354159,2.354159,2.354159,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;103;-2400,16;Inherit;False;Variation;17;;1;487039bf64ba820499085da4bb1fd9c4;1,34,0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;89;-2207,-288;Inherit;False;Property;_UseVariation;UseVariation;16;2;[PerRendererData];[Toggle];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-2304,768;Inherit;False;Property;_Intensity;Intensity;4;1;[HideInInspector];Create;True;0;0;0;False;0;False;1;0.263;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;110;-1473,1088;Inherit;False;Scene Depth Fade;12;;100;b80e7cce07f3ff241b5ed9e75228c4d5;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;95;-1264,832;Inherit;False;Property;_UseZScaleFade;UseZScaleFade;10;2;[PerRendererData];[Toggle];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;39;-1472,1168;Inherit;False;Orthographic Fade;-1;;101;07ff034ed2c5b5b4783cf486c6ebd7b0;0;0;1;FLOAT;6
Node;AmplifyShaderEditor.RegisterLocalVarNode;43;-1872,608;Inherit;False;RayPreAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;91;-1248,448;Inherit;False;Property;_UseCameraDepthFade;UseCameraDepthFade;15;2;[PerRendererData];[Toggle];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;96;-1264,656;Inherit;False;Property;_UseCameraDistanceFade;UseCameraDistanceFade;11;2;[PerRendererData];[Toggle];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;102;-1264,752;Inherit;False;Camera Distance Fade;1;;102;f992419659205874689e17721bd92798;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;101;-1248,528;Inherit;False;Camera Depth Fade;6;;103;b003bbeb8eacda14fa920f9527150e3e;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;93;-1232,1232;Inherit;False;Property;_UseSceneDepthFade;UseSceneDepthFade;9;2;[PerRendererData];[Toggle];Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;84;-1456,-320;Inherit;False;Property;_RenderOffset;Render Offset;5;1;[PerRendererData];Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;105;16,96;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Distant Lands/Lumen/Flare;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;2;False;;True;7;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637866973230697328;  Blend;0;0;Two Sided;0;637866973244832349;Forward Only;0;0;Cast Shadows;0;637866993292988272;  Use Shadow Threshold;0;0;Receive Shadows;0;637866993300641595;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;107;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=7CE67D1EF1821C9F0A788928B57E7FD888396FD6