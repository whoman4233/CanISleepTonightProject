...
namespace MK.Toon.Editor
{
    internal class UI
    {
        ...
        internal static readonly GUIContent detailUVSet = new GUIContent
        (
            "UV Set", 
            "Switches the base uv set for the details albedo map and the detail normal map."
        );
        ...
        (
            ...
            "Threshold defined for the main light/shadow. \n\n" +
            "0: Material is more lit (also depends on wrapped lighting => advanced tab). \n" +
            "1: Material is fully shadowed, no lights are visible."
        );
        internal static readonly GUIContent additionalLightsThreshold = new GUIContent
        (
            "Additional Light Threshold", 
            "Threshold defined for additional light/shadow. \n\n" +
            "0: Material is more lit (also depends on wrapped lighting => advanced tab). \n" +
            "1: Material is fully shadowed, no lights are visible."
        );
        internal static readonly GUIContent additionalLightsFalloff = new GUIContent
        (
            "Additional Lights Falloff", 
            "This property lets you kind of control the shape the additional lights.\n\n" +
            "0: Light appears more in shape with the range gizmo from the light editor ui. Light falloff will show more consistent across the range.\n" +
            "1: Light behaves with more physical accuracy, featuring a falloff that scales based on its distance to surfaces."
        );
