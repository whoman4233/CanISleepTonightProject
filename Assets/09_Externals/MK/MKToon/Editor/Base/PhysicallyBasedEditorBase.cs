...
namespace MK.Toon.Editor
{
    ...
    internal abstract class PhysicallyBasedEditorBase : SimpleEditorBase
    {
        ...
        private MaterialProperty _detailUVSet;
        ...
        protected override void FindProperties(MaterialProperty[] props)
        {
            ...
            _detailUVSet = FindProperty(Properties.detailUVSet.uniform.name, props);
        ...
        {
            #if MK_TOON_ALLOW_DETAIL_MAPS_UV_7
            materialEditor.ShaderProperty(_detailUVSet, UI.detailUVSet);
            #endif
