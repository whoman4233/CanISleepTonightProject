...
Shader "MK/Toon/URP/Standard/Physically Based + Outline"
{
	Properties
	{
		...
		[Enum(UV0,0,UV7,7)] _DetailUVSet ("", int) = 0
		...
		_AdditionalLightsThreshold ("", Range (0.0, 1.0)) = 0.5
		_AdditionalLightsFalloff ("", Range (0.0, 1.0)) = 1.0
	...
	SubShader
	{
		...
		Pass 
		{
			...
			#define MK_STANDARD
			#include_with_pragmas "../../Lib/DotsInstancingSetup.hlsl"
			#include_with_pragmas "../../Lib/ShadowCaster/Setup.hlsl"
		...
		Pass
		{
			...
			#define MK_STANDARD
			#include_with_pragmas "../../Lib/DotsInstancingSetup.hlsl"
			#include_with_pragmas "../../Lib/Meta/Setup.hlsl"
			ENDHLSL
		}
		...
		Pass
		{
			...
			Name "Outline" Tags { "LightMode" = "MKToonOutline" }
			Cull Front
			...
			#define MK_STANDARD
			#include_with_pragmas "../../Lib/DotsInstancingSetup.hlsl"
			#include_with_pragmas "../../Lib/Outline/Setup.hlsl"
		...
		Pass
        {
			PackageRequirements 
			{
				"com.unity.render-pipelines.universal":"[17.0,99.99]"
			}
            Stencil
			{
				Ref [_StencilRef]
		...
		Pass
        {
            ...
            #include_with_pragmas "../../Lib/MotionVectors/Setup.hlsl"
            ENDHLSL
        }
